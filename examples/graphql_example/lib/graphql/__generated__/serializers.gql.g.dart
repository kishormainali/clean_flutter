...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(GLaunchData.serializer)
      ..add(GLaunchData_launch.serializer)
      ..add(GLaunchData_launch_launch_site.serializer)
      ..add(GLaunchData_launch_rocket.serializer)
      ..add(GLaunchData_launch_rocket_rocket.serializer)
      ..add(GLaunchFind.serializer)
      ..add(GLaunchReq.serializer)
      ..add(GLaunchVars.serializer)
      ..add(GLaunchesData.serializer)
      ..add(GLaunchesData_launches.serializer)
      ..add(GLaunchesData_launches_launch_site.serializer)
      ..add(GLaunchesData_launches_rocket.serializer)
      ..add(GLaunchesData_launches_rocket_rocket.serializer)
      ..add(GLaunchesReq.serializer)
      ..add(GLaunchesVars.serializer)
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<GLaunchesData_launches?>())
      ..addBuilderFactory(
          const FullType(
