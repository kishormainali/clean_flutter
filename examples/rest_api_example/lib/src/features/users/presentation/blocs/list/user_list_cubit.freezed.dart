...
mixin _$UserListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<UserModel> users, bool isLoading) loaded,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<UserModel> users, bool isLoading)? loaded,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<UserModel> users, bool isLoading});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<UserModel> users, this.isLoading = false})
      : _users = users;
  ...
  @override
  String toString() {
    return 'UserListState.loaded(users: $users, isLoading: $isLoading)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(users, isLoading);
  }
