...
extension ApiExceptionDioX on DioException {
  ...
  ApiException _handleBadResponse(Response<dynamic>? response) {
    ...
    final message =
        responseData.get<String>('message') ?? response.statusMessage;
...
abstract class DioExtensionMessages {
  ...
  static const String validationError =
      'Something wrong with user input please try again.';
  static const String payloadToLarge =
      'The server will not accept the request, because the request entity is too large.';
  static const String requestCancelled = 'Request was cancelled by user.';
  static const String unstableConnection =
      'Looks like you have an unstable network at the moment, please try again when network stabilizes.';
  static const String networkError =
      'Looks like you are not connected to the internet, please try again when you are connected to the internet.';
  static const String requestTimeout =
      'Looks like the server is taking to long to respond, please try again in sometime.';
  static const String unauthorizedError =
      'Looks like you are not authorized to perform this action.';
  static const String parseError =
      'Looks like the server is not responding in the expected format, please try again in sometime.';
  static const String badCertificateError =
      'Looks like the server is configured with a bad certificate, please try again in sometime.';
  static const String badRequestError =
      'Looks like the server is not able to process the request, please try again in sometime.';
}
